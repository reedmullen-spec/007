"""Read-only: inspects the actual stored Value/Currency/Source for named
rows, to diagnose why megaprojects are scoring as "value below floor".
...
def main() -> int:
    ...
    for name in names:
        ...
        for row in rows:
            ...
            currency = ((props.get("Currency") or {}).get("select") or {}).get("name", "")
            ...
            print(f"{title[:70]:70s} Value={value!r} {currency} Source={source} "
